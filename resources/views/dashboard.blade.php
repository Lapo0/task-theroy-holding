<x-app-layout>
    ...
    <div class="container mx-auto px-4">
        <!-- Pulsanti di Filtro -->
        <div class="mb-6 flex space-x-4 shadow-md rounded-lg overflow-hidden animate__animated animate__fadeInUp hover:shadow-xl transition-shadow duration-300"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('posts.save', $post->id) }}" method="POST" class="save-form"
                                            ...
                                            <button type="button"
                                                ...
                                                <i
                                                    class="pr-1 {{ $post->savedByUsers->contains(Auth::user()->id) ? 'fas fa-bookmark' : 'far fa-bookmark' }}"></i>
                                            </button>
                                        </form>
                                    </div>
